...
public:
   ...
   virtual Symbol CheckBranchType(ClassTable* classtable) = 0;
#ifdef Case_EXTRAS
   Case_EXTRAS
#endif
};
...
public:
   ...
   void dump(ostream& stream, int n);
   void CheckFeatureType(ClassTable *classtable);
   void AddToTable(Symbol class_name);
   void AddMethodToTable(Symbol class_name, ClassTable *classtable);
   void AddAttribToTable(Symbol class_name, ClassTable *classtable){};
...
public:
   ...
   Symbol CheckBranchType(ClassTable *classtable);
...
public:
   ...
   Symbol CheckExprType(ClassTable *classtable);
